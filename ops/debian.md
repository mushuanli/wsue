...
apt install locales ssh linux-image-amd64 firmware-iwlwifi wireless-tools grub-pc systemd aptitude net-tools bzip2 vim tmux wpasupplicant network-manager openssh-server samba firmware-linux-nonfree
